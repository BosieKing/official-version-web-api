...
namespace BusinesLogic.BackEnd.TenantMenuManage
{
    ...
    public class TenantMenuManageServiceImpl : ITenantMenuManageService
    {
        ...
        {
            T_TenantMenuButton data = input.Adapt<T_TenantMenuButton>();
            return await _tenantMenuManageDao.AddAsync<T_TenantMenuButton>(data);
        }
        #endregion
        ...
        public async Task<bool> UpdateTenantDirectory(UpdateTenantDirectoryInput input)
        {
            T_TenantDirectory data = input.Adapt<T_TenantDirectory>();
            data.Id = input.Id;
            return await _tenantMenuManageDao.UpdateAsync<T_TenantDirectory>(data);
        }
        ...
        public async Task<bool> UpdateTenantMenuButton(UpdateTenantMenuButtonInput input)
        {
            T_TenantMenuButton data = input.Adapt<T_TenantMenuButton>();
            data.Id = input.Id;
            return await _tenantMenuManageDao.UpdateAsync<T_TenantMenuButton>(data);
        }
